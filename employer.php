...
<div id="titlebar">
	<div class="container">
		<div class="ten columns">
			...
			<h2><center>How Employer Module Works</center></h2>
		</div>
...
<div class="container">
	...
	<div class="padding-right" >
		...
		<p class="margin-reset">
			A growing economy like India requires a large and skilled workforce. However, the lack of quality employee has created roadblocks to growth of company. Skill shortage is evident in every sector of the company.We are developing web portal which gives best employee to the company as per their requirement. So that employer is able to get their dream employee!!
		</p>

		<br>
		<p> <strong>Flow of Employer Module</strong> ::</p>
		...
		<ul class="list-1">
			<li>Our system will find what are the skills which are required to work in particular company. </li>
			<li>By analyzing jobseeker's profile recommender will suggest best employee to employer.</li>
			<li> System will generate skillset which are needed to work in paricular company.</li>
		</ul>

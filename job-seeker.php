...
<div id="titlebar">
	<div class="container">
		<div class="ten columns">
			...
			<h2><center>How Job Seeker Module Work</center></h2>
		</div>
...
<div class="container">
	...
	<div class="padding-right" >
		...
		<p class="margin-reset">
			There are lots of job portal available on internet, users need to create accounts on every job portal to know job details related to their skills. We are developing web portal which fetch all the jobs based on skills from different job portals and company websites. If user does not match the skills which industry needed we suggest the best training institutes to them to fill the industry skill gap!!
		</p>

		<br>
		<p> <strong>Flow of Job-Seeker</strong> ::</p>
		...
		<ul class="list-1">
			<li>Our system will take all necessary information required to recommend you best suited job. </li>
			<li>By analyzing the skill that you have recommender will suggest you best jobs.</li>
			<li>Again if you want to work in particular company then system will analyze skills which you have and which are actually required. </li>
			<li> To avail the skills required by particular company system will recommend yoy various training provider.</li>
			<li> System will generate the skill gap analysis graph.</li>
		</ul>

...
fun1('https://www.naukri.com/networking-jobs');
...
$job_description=$xpath3->query('//div[contains(@class, "hdSec")]//h1[contains(@class, "small_title")]');
...
$domxml->save('job_networking.xml') ;  

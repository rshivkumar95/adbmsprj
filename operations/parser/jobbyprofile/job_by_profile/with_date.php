...
*/
 fun1('https://www.naukri.com/computer-operator-jobs');
...
/*
$date=$xpath3->query('(//div[contains(@class, "sumFoot")]//span)');
$date1=$date->item(2)->nodeValue;
...
/*if(trim($var2)==="Few Hours" or trim($var2)=="Just")
{
...
$domxml->save('computer_operator_jobs.xml') ;  

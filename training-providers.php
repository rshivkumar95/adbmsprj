...
<div id="titlebar">
	<div class="container">
		<div class="ten columns">
			...
			<h2><center>How Training Provider Module Works</center></h2>
		</div>
...
<div class="container">
	...
	<div class="padding-right" >
		...
		<ul class="list-1">
			<li>Training provider will reduce the skill gap.</li>
			<li>By analyzing skill gap our system  will suggest training provider to reduce skill gap.</li>
		</ul>
